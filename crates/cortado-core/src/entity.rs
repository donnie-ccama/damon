...
impl RuntimeId {
    ...
    /// CLI binary; overridable for tests, e.g. CORTADO_BIN_CLAUDE=sleep.
    pub fn binary(&self) -> String {
        let var = format!("CORTADO_BIN_{}", self.as_str().to_uppercase());
...
mod tests {
    ...
    fn runtime_binary_env_seam() {
        ...
        std::env::set_var("CORTADO_BIN_CLAUDE", "sleep");
        assert_eq!(RuntimeId::Claude.binary(), "sleep");
        std::env::remove_var("CORTADO_BIN_CLAUDE");
    }
