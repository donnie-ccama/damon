...
#[derive(Subcommand)]
enum Cmd {
    /// Scaffold ~/cortado plus config.toml and models.toml
    Init,
...
#[derive(Subcommand)]
enum AgentCmd {
    /// Create an agent: cortado agent new <team>/<Name> --repo-new|--repo-clone URL|--repo-worktree PATH
    New {
        reference: String,
...
impl From<RuntimeArg> for cortado_core::entity::RuntimeId {
